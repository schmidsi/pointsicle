...
import type { NetworkSubgraphTypes } from './sources/network_subgraph/types';
import * as importedModule$0 from "./sources/network_subgraph/introspectionSchema";
...
export type GraphNetwork_filter = {
  ...
  activeAllocationCount?: InputMaybe<Scalars['Int']>;
  activeAllocationCount_not?: InputMaybe<Scalars['Int']>;
  activeAllocationCount_gt?: InputMaybe<Scalars['Int']>;
  activeAllocationCount_lt?: InputMaybe<Scalars['Int']>;
  activeAllocationCount_gte?: InputMaybe<Scalars['Int']>;
  activeAllocationCount_lte?: InputMaybe<Scalars['Int']>;
  activeAllocationCount_in?: InputMaybe<Array<Scalars['Int']>>;
  activeAllocationCount_not_in?: InputMaybe<Array<Scalars['Int']>>;
...
export type SubgraphMeta_filter = {
  ...
  categories_contains?: InputMaybe<Array<Scalars['String']>>;
  categories_contains_nocase?: InputMaybe<Array<Scalars['String']>>;
  categories_not_contains?: InputMaybe<Array<Scalars['String']>>;
  categories_not_contains_nocase?: InputMaybe<Array<Scalars['String']>>;
  /** Filter for the block changed event. */
  _change_block?: InputMaybe<BlockChangedFilter>;
...
export type MeshContext = NetworkSubgraphTypes.Context & BaseMeshContext;
...
const importFn: ImportFn = <T>(moduleId: string) => {
  ...
  switch(relativeModuleId) {
    case ".graphclient/sources/network_subgraph/introspectionSchema":
...
const networkSubgraphTransforms = [];
const additionalTypeDefs = [] as any[];
const networkSubgraphHandler = new GraphqlHandler({
              name: "network_subgraph",
              config: {"endpoint":"https://gateway-arbitrum.network.thegraph.com/api/e8c6e4f2a7fc3b832f3917a050e8057a/subgraphs/id/DZz4kDTdmzWLWsV373w2bSmoar3umKKH9y82SUKr5qmp"},
              baseDir,
              cache,
              pubsub,
              store: sourcesStore.child("network_subgraph"),
              logger: logger.child("network_subgraph"),
              importFn,
            });
sources[0] = {
          name: 'network_subgraph',
          handler: networkSubgraphHandler,
          transforms: networkSubgraphTransforms
        }
...
const merger = new(BareMerger as any)({
  ...
  return {
    ...
    get documents() {
      return [
      {
        document: PointsicleSubgraphsDocument,
        get rawSDL() {
          return printWithCache(PointsicleSubgraphsDocument);
        },
        location: 'PointsicleSubgraphsDocument.graphql'
      }
    ];
    },
    fetchFn,
...
export type PointsicleSubgraphsQueryVariables = Exact<{ [key: string]: never; }>;


export type PointsicleSubgraphsQuery = { subgraphDeploymentSchemas: Array<(
    Pick<SubgraphDeploymentSchema, 'id'>
    & { manifest?: Maybe<(
      Pick<SubgraphDeploymentManifest, 'id'>
      & { deployment?: Maybe<(
        Pick<SubgraphDeployment, 'id'>
        & { versions: Array<(
          Pick<SubgraphVersion, 'id'>
          & { subgraph: (
            Pick<Subgraph, 'id'>
            & { metadata?: Maybe<Pick<SubgraphMeta, 'id' | 'displayName' | 'description'>> }
          ) }
        )> }
      )> }
    )> }
...
export const PointsicleSubgraphsDocument = gql`
    query PointsicleSubgraphs {
  subgraphDeploymentSchemas(
    where: {schema_contains: "type PointsicleAllocation @entity"}
  ) {
    id
    manifest {
      id
    ...
    ` as unknown as DocumentNode<PointsicleSubgraphsQuery, PointsicleSubgraphsQueryVariables>;


export type Requester<C = {}, E = unknown> = <R, V>(doc: DocumentNode, vars?: V, options?: C) => Promise<R> | AsyncIterable<R>
export function getSdk<C, E>(requester: Requester<C, E>) {
  return {
    PointsicleSubgraphs(variables?: PointsicleSubgraphsQueryVariables, options?: C): Promise<PointsicleSubgraphsQuery> {
      return requester<PointsicleSubgraphsQuery, PointsicleSubgraphsQueryVariables>(PointsicleSubgraphsDocument, variables, options) as Promise<PointsicleSubgraphsQuery>;
    }
  };
}
